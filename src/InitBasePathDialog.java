...
public class InitBasePathDialog extends JDialog {
    private JPanel contentPane;
    private JButton buttonOK;
    private JButton buttonCancel;
    private JTextField BaseProjectPath;
    private JTextField TestUnitPath;
    PropertiesComponent properties;


    public InitBasePathDialog(Project project) {
    ...
    private void onOK() {
        // add your code here
        String baseProjectPath = BaseProjectPath.getText();
        String testUnitPath = TestUnitPath.getText();
        properties.setValue("PycharmTestUnit.BaseSourcePath", baseProjectPath);
        properties.setValue("PycharmTestUnit.TestUnitPath", testUnitPath);
        dispose();
    }
...
//        InitBasePathDialog dialog = new InitBasePathDialog();
//        dialog.pack();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        BaseProjectPath = new JTextField();
        panel1.add(BaseProjectPath, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        TestUnitPath = new JTextField();
        panel1.add(TestUnitPath, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
